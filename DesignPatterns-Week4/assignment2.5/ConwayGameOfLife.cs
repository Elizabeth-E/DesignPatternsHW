...
namespace ConwayGameOfLife
{
    public class ConwayGameOfLife
    {
        ...
        private ILifeBehaviour lifeBehaviour;
        public ILifeBehaviour LifeBehaviour
        {
            get { return lifeBehaviour; }
            set { lifeBehaviour = value; }
        }
        // constructor
        public ConwayGameOfLife()
        {
            ...
            LifeBehaviour = new StandardLifeBehaviour();
            InitializeLife();
        }
        ...
        public virtual bool CellShouldLive(bool livingCell, int neighbourCount)
        {
            // B3/S23
